...
@Component({
  ...
  templateUrl: './resultat-notation.html',
  styleUrl: './resultat-notation.css'
})
export class ResultatNotation implements OnInit {
  ...
  ajouterPart(): void {
    ...
    this.router.navigateByUrl('detail-notation');
  }
